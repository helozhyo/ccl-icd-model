...
CHECKPOINT = "/root/autodl-tmp/classifier_output/best_classifier_v2.pt"
...
def main():
    ...
    td = ckpt.get('best_td', 0.3)
    ts = ckpt.get('best_ts', 0.45)
    ...
    gen(0.30, 0.45, 2, '/root/autodl-tmp/sub_v4a.txt')  # dev best
    gen(0.25, 0.40, 3, '/root/autodl-tmp/sub_v4b.txt')  # v3b params (A榜历史最优)
    gen(0.25, 0.45, 3, '/root/autodl-tmp/sub_v4c.txt')  # mixed
    gen(0.30, 0.40, 3, '/root/autodl-tmp/sub_v4d.txt')  # td=0.3, lower ts
    print('Done')
