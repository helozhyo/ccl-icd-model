#!/usr/bin/env python3
"""
CCL 2026 ICD自动编码任务 - 自定义训练循环（避免OOM）
使用device_map分载 + CPU offload优化器状态
"""
...
from transformers import (
    ...
    set_seed, get_cosine_schedule_with_warmup,
)
...
def main():
    ...
    # 2. 加载模型（device_map自动分载）
    print("=" * 60)
    print("2. 加载模型（device_map='auto'）...")
    ...
    for epoch in range(CFG["num_epochs"]):
        ...
        print(f"\n  Epoch {epoch+1} 完成, avg_loss={epoch_loss:.4f}")
