#!/usr/bin/env python3
"""
CCL 2026 ICD - LoRA微调 (InternLM2-1_8B, max_length=768保证label有token)
"""
...
CFG = {
    "max_length": 768,    # 768保证prompt不占满所有token
    "batch_size": 1,
...
def main():
    ...
    if torch.cuda.is_available():
        ...
        print(f"   GPU mem after load: {mem:.2f}GB")
    ...
    print(f"batch_size={CFG['batch_size']}, max_length={CFG['max_length']}")
